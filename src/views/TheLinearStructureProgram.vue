  ...
  <div class="home">
    ...
    <v-form v-model="valid">
      <v-container>
        ...
        <v-card-title v-if="len1 && len2 && len3">
...
export default {
  ...
  computed: {
    square: function () {
      let semiPerimeter = (this.len1 + this.len2 + this.len3) * 0.5;
      let result = Math.sqrt(semiPerimeter * (semiPerimeter - this.len1) * (semiPerimeter - this.len2) * (semiPerimeter - this.len3));
      return result
    }
    }
};
